...
{
    public const bool IsRuntimeImplemented = true;
    ...
    public const string ServerSideVmPackage = "Preagonal.Scripting.GS2Engine";
    public const bool IsServerSideVmWired = true;
    public const string Blocker =
        "NC script open/update and client bytecode compilation use GS2Compiler/GS2Engine. Full NPC-server event lifecycle remains in progress.";
}
