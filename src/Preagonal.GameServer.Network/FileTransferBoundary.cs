...
public static class FileTransferBoundary
{
        ...
        ClientVersionId clientVersion)
    {
        ...
        if (!ignoreChecksum && file is not null && Crc32.Compute(file.Data) == clientChecksum)
        {
            ...
            return new(FileTransferDecision.UpToDate, Sent: false, KnownFiles: []);
        }
        ...
        ClientVersionId clientVersion)
    {
        ...
        if (clientVersion < ClientVersionId.Client21)
        {
            ...
            return new(FileTransferDecision.FileMissing, Sent: false, KnownFiles: []);
        }
        ...
        ClientVersionId clientVersion)
    {
        ...
        return new(totalDownloadSize, missingFiles);
    }
        ...
        ClientVersionId clientVersion)
    {
        ...
        return new(FileTransferDecision.SentFile, Sent: true, knownFiles);
    }
