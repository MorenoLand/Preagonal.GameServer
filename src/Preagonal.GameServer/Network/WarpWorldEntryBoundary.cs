...
public static class WarpWorldEntryBoundary
{
        ...
        PlayerWarpSettings settings)
    {
        ...
        if (unstickLevel is null)
            return new(false, false, PlayerWarpStopPoint.Failed, null);
        ...
        LevelWarpRequest request)
    {
        ...
        if (level is null)
        {
            ...
            return new(false, LevelEntryStopPoint.MissingLevel, null);
        }
        ...
        return new(true, LevelEntryStopPoint.BeforeSendLevelRuntime, level);
    }
