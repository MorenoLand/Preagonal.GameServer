...
public static class NwLevelParser
{
        ...
        ICollection<NwLevelNpc> npcs)
    {
        ...
        npcs.Add(new(image, x, y, JoinWithTrailingNewlines(code)));
    }
        ...
        ICollection<NwLevelSign> signs)
    {
        ...
        signs.Add(new(x, y, JoinWithTrailingNewlines(text)));
    }
        ...
        ICollection<NwLevelBaddy> baddies)
    {
        ...
        baddies.Add(new(Atoi(tokens[1]), Atoi(tokens[2]), Atoi(tokens[3]), verses));
    }
    ...
    private static void ParseChest(IReadOnlyList<string> tokens, ICollection<NwLevelChest> chests)
    {
        ...
        chests.Add(new(Atoi(tokens[1]), Atoi(tokens[2]), itemType, Atoi(tokens[4])));
    }
