...
public static class IncomingPlayerPropsParser
{
        ...
        ClientVersionId clientVersion)
    {
        ...
        return new(PlayerPropertyId.Gani, GCharValue: 10, StringValue: image);
    }
        ...
        ClientVersionId clientVersion)
    {
        ...
        return new(PlayerPropertyId.SwordPower, GCharValue: power, StringValue: image);
    }
        ...
        ClientVersionId clientVersion)
    {
        ...
        return new(PlayerPropertyId.ShieldPower, GCharValue: power, StringValue: image);
    }
