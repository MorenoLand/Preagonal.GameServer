...
| Built-in quests/missions/resource-defined systems | Out of scope unless source-proven | No dedicated C++ core runtime found | Absence is faithful behavior; do not implement built-ins without recovered original C++ source or exact dependency proof |
